...
void Set_Time (uint8_t sec,uint8_t min, uint8_t hour, uint8_t date, uint8_t month, uint8_t year)
{
	uint8_t set_time[7];
...
//tạo mạng để lưu giá trị BCD mà ta nhận được từ RTC
void Get_Time (void)
{
	uint8_t get_time[7];
...
char buffer [15]; //tạo bộ đệm để lưu trữ gtri tương đương để có thể hiện thị trên LCD
